...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=SoreThroat Demo Installer\n"
      else:
        line="OutputBaseFilename=SoreThroat Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the SoreThroat Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the SoreThroat installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=SoreThroat Demo installer\n"
     else:
       line="SetupWindowTitle=SoreThroat installer\n"
