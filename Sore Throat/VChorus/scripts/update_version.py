...
def main():
  ...
  plistpath = scriptpath + "/resources/SoreThroat-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SoreThroat-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SoreThroat-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SoreThroat-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SoreThroat-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/SoreThroat.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/SoreThroat.iss",inplace=1):
