...
stereoRev(sz,dmp) = _ <: _,_ : re.stereo_freeverb(sz,dmp,1.0,0.0);
...
gainL(a,e)     = cos((panPos(a) + 1.0) * PI / 4.0) * cos(deg2rad(e));
gainR(a,e)     = sin((panPos(a) + 1.0) * PI / 4.0) * cos(deg2rad(e));
